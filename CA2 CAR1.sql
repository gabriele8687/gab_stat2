...
-- Insert values into [CarSolddetails] 
...
--total amount, plus additional tax operation 

select Owing from Invoicedetails
select Owing, Owing +10 as plus10,
Owing * 2  as doubled,Owing + Totals_amount as total 
from Invoicedetails 

-- select command
select First_Name, Last_Name,post_code from Employee
--  select where clause 
select * from CustomerDeatails where date_acquired >= '2021';

SELECT * FROM Customer
WHERE CustomerID=31;

SELECT [CustomerID], [Active], [Carsold] 
